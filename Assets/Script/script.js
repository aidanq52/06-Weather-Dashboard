$(document).ready(function(){
    ...
    function renderButtons(){
        ...
        var uniqueCitySet = new Set(cityButtonArray);

        cityButtonArray = [...uniqueCitySet];
        ...
        for(i=0; i < cityButtonArray.length; i++){
            currentCity= cityButtonArray[i].replace(" ","+")
            buttonsDiv.append("<button class=city value="+currentCity+">"+cityButtonArray[i]+"</button>"+"<br>");
        }
